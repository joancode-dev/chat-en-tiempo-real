...
<table class="table table-bordered table-striped">
	<tr>
		<th width="70%">Nombre de usuario</td>
...
{
	$status = '';
	$current_timestamp = strtotime(date("Y-m-d H:i:s") . '- 10 segundo');
	...
	<tr>
		...
		<td>'.$status.'</td>
		<td><button type="button" class="btn btn-info btn-xs start_chat" data-touserid="'.$row['user_id'].'" data-tousername="'.$row['username'].'">Comenzar chat</button></td>
	</tr>
	';
}
